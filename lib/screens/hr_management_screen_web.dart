...
class HrManagementScreenWeb extends StatefulWidget {
  ...
  @override
  State<HrManagementScreenWeb> createState() => _HrManagementScreenWebState();
}

class _HrManagementScreenWebState extends State<HrManagementScreenWeb> {
