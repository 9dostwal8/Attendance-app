...
class _SystemUsersTabState extends State<SystemUsersTab> {
  ...
  Widget build(BuildContext context) {
    ...
    final hrAdminCount = allUsers
        .where((u) => u.role == 'hr' || u.role == 'admin')
        .length;
    final supervisorCount = allUsers
              ...
              children: [
                ...
                _buildDropdownFilter(
                  ...
                  items: const [
                    DropdownMenuItem(
                      value: 'all',
                      child: Text('All Access Statuses'),
                    ),
                    DropdownMenuItem(
                      value: 'active',
                      child: Text('Active Access'),
                    ),
                    DropdownMenuItem(
                      value: 'disabled',
                      child: Text('Disabled / Revoked'),
                    ),
                  ],
                  onChanged: (val) {
                    if (val != null) {
          ...
          return Column(
            ...
            children: [
              ...
              ListTile(
                ...
                subtitle: const Text(
                  'Approval management, team shift supervision',
                ),
                leading: Radio<String>(
                  value: 'supervisor',
                  // ignore: deprecated_member_use
              ...
              ListTile(
                ...
                subtitle: const Text(
                  'Standard clocking and request submission',
                ),
                leading: Radio<String>(
                  value: 'employee',
                  // ignore: deprecated_member_use
        ...
        ElevatedButton(
          onPressed: () {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  'Updated system role for ${user.name} to $selectedRole',
                ),
